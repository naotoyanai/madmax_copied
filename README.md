...
また, MLaaS（Machine Learning as a Service）の様な外部サービスを利用せずに, 自社の組織に機械学習モデルを搭載した簡易サーバを手軽に設置して利用することができるためプライバシーも守られる.

## ELM Blocker の機能
例えば、とある企業からアクセスされるWebサイトの傾向といった個人情報を第三者に渡していることになる.
